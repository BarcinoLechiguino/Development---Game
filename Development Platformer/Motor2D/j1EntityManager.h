...
public:
	...
	j1Player1*			playere;				//Pointer to the j1Player1 class. Will represent P1. Change name to player1 later.
	j1Player2*			player2;			//Pointer to the j1Player1 class. Will represent P2.
	j1Player2*			player2e;			//Pointer to the j1Player1 class. Will represent P2.
	//j1Mecha*			mecha;
	//j1Alien*			alien;
