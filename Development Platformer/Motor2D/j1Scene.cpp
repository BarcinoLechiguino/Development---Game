...
void j1Scene::LoadGuiElements()
{
	...
	_TTF_Font* font = App->font->Load("fonts/Minecraftia-Regular.ttf");
	...
	_TTF_Font* inputFont = App->font->Load("fonts/MajorMonoDisplay.ttf", 30);
	...
	_TTF_Font* scrollFont = App->font->Load("fonts/MajorMonoDisplay.ttf", 24);
